...
class CommentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.CommentTableMap';
     ...
     */
    const OM_CLASS = '\\App\\PropelModels\\Comment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Comment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\PropelModels\\Comment');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\PropelModels\Comment) { // it's a model object
