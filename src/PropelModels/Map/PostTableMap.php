...
class PostTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.PostTableMap';
     ...
     */
    const OM_CLASS = '\\App\\PropelModels\\Post';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Post';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\PropelModels\\Post');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Comment', '\\App\\PropelModels\\Comment', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':post_id',
    1 => ':id',
        ...
        $this->addRelation('Tag', '\\App\\PropelModels\\Tag', RelationMap::MANY_TO_MANY, array(), null, null, 'Tags');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\PropelModels\Post) { // it's a model object
