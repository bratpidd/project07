...
class TagTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PropelModels.Map.TagTableMap';
     ...
     */
    const OM_CLASS = '\\App\\PropelModels\\Tag';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PropelModels.Tag';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\PropelModels\\Tag');
    ...
    {
        $this->addRelation('PostTag', '\\App\\PropelModels\\PostTag', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':tag_id',
    1 => ':id',
        ...
        $this->addRelation('Post', '\\App\\PropelModels\\Post', RelationMap::MANY_TO_MANY, array(), null, null, 'Posts');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\PropelModels\Tag) { // it's a model object
