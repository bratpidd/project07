...
use App\PropelModels\Map\TagTableMap;
...
abstract class Tag implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\PropelModels\\Map\\TagTableMap';
    ...
    /**
     * Initializes internal state of App\PropelModels\Base\Tag object.
     */
     ...
     * @return $this|\App\PropelModels\Tag The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\PropelModels\\Tag'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\PropelModels\Tag
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\PropelModels\Tag The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\PropelModels\Tag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\PropelModels\Tag Clone of current object.
     * @throws PropelException
     */
    ...
    public function initPosts()
    {
        ...
        $this->collPosts->setModel('\App\PropelModels\Post');
    }
