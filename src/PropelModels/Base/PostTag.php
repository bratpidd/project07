...
abstract class PostTag implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\PropelModels\\Map\\PostTagTableMap';
    ...
    /**
     * Initializes internal state of App\PropelModels\Base\PostTag object.
     */
     ...
     * @return $this|\App\PropelModels\PostTag The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\PropelModels\\PostTag'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\PropelModels\PostTag
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\PropelModels\PostTag The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\PropelModels\PostTag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\PropelModels\PostTag Clone of current object.
     * @throws PropelException
     */
