...
class CommentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Services.PostService.Persistence.Propel.Map.CommentTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Services\\PostService\\Persistence\\Propel\\Comment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Services.PostService.Persistence.Propel.Comment';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Text', 'PostId', ),
        self::TYPE_CAMELNAME     => array('id', 'text', 'postId', ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID, CommentTableMap::COL_TEXT, CommentTableMap::COL_POST_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'text', 'post_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Text' => 1, 'PostId' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'text' => 1, 'postId' => 2, ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID => 0, CommentTableMap::COL_TEXT => 1, CommentTableMap::COL_POST_ID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'text' => 1, 'post_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'postId' => 'POST_ID',
        'comment.postId' => 'POST_ID',
        'CommentTableMap::COL_POST_ID' => 'POST_ID',
        'COL_POST_ID' => 'POST_ID',
        'post_id' => 'POST_ID',
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Services\\PostService\\Persistence\\Propel\\Comment');
  ...
  array (
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(CommentTableMap::COL_POST_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Services\PostService\Persistence\Propel\Comment) { // it's a model object
