...
use App\Services\PostService\Persistence\Propel\Tag;
...
class TagTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Services.PostService.Persistence.Propel.Map.TagTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Services\\PostService\\Persistence\\Propel\\Tag';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Services.PostService.Persistence.Propel.Tag';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID, TagTableMap::COL_TITLE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID => 0, TagTableMap::COL_TITLE => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Services\\PostService\\Persistence\\Propel\\Tag');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Post', '\\App\\Services\\PostService\\Persistence\\Propel\\Post', RelationMap::MANY_TO_MANY, array(), null, null, 'Posts');
    } // buildRelations()
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(TagTableMap::COL_TITLE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Services\PostService\Persistence\Propel\Tag) { // it's a model object
