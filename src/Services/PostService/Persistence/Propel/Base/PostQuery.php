...
use App\Services\PostService\Persistence\Propel\Map\PostTableMap;
 ...
 *
 * @method     \App\Services\PostService\Persistence\Propel\PostTagQuery|\App\Services\PostService\Persistence\Propel\CommentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PostQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Services\PostService\Persistence\Propel\Base\PostQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Services\\PostService\\Persistence\\Propel\\Post', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\Services\PostService\Persistence\Propel\Comment object
     *
     * @param \App\Services\PostService\Persistence\Propel\Comment|ObjectCollection $comment the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPostQuery The current query, for fluid interface
     */
    ...
    {
        if ($comment instanceof \App\Services\PostService\Persistence\Propel\Comment) {
            return $this
            ...
            throw new PropelException('filterByComment() only accepts arguments of type \App\Services\PostService\Persistence\Propel\Comment or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Services\PostService\Persistence\Propel\CommentQuery A secondary query class using the current class as primary query
     */
    public function useCommentQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinComment($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Comment', '\App\Services\PostService\Persistence\Propel\CommentQuery');
    }

    /**
     * Use the Comment relation Comment object
     *
     * @param callable(\App\Services\PostService\Persistence\Propel\CommentQuery):\App\Services\PostService\Persistence\Propel\CommentQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @param string $typeOfExists Either ExistsCriterion::TYPE_EXISTS or ExistsCriterion::TYPE_NOT_EXISTS
     *
     * @return \App\Services\PostService\Persistence\Propel\CommentQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \App\Services\PostService\Persistence\Propel\CommentQuery The inner query object of the NOT EXISTS statement
     */
