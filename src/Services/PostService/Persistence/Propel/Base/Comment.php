...
abstract class Comment implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Services\\PostService\\Persistence\\Propel\\Map\\CommentTableMap';
    ...
    /**
     * Initializes internal state of App\Services\PostService\Persistence\Propel\Base\Comment object.
     */
     ...
     * @return $this|\App\Services\PostService\Persistence\Propel\Comment The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CommentTableMap::translateFieldName('PostId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Services\\PostService\\Persistence\\Propel\\Comment'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Services\PostService\Persistence\Propel\Comment
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Services\PostService\Persistence\Propel\Comment The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Services\PostService\Persistence\Propel\Comment (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Services\PostService\Persistence\Propel\Comment Clone of current object.
     * @throws PropelException
     */
