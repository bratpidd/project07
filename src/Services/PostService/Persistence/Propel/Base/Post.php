...
abstract class Post implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Services\\PostService\\Persistence\\Propel\\Map\\PostTableMap';
    ...
    /**
     * Initializes internal state of App\Services\PostService\Persistence\Propel\Base\Post object.
     */
     ...
     * @return $this|\App\Services\PostService\Persistence\Propel\Post The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Services\\PostService\\Persistence\\Propel\\Post'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commentsScheduledForDeletion !== null) {
                if (!$this->commentsScheduledForDeletion->isEmpty()) {
                    \App\Services\PostService\Persistence\Propel\CommentQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Services\PostService\Persistence\Propel\Post
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Services\PostService\Persistence\Propel\Post The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Services\PostService\Persistence\Propel\Post (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Services\PostService\Persistence\Propel\Post Clone of current object.
     * @throws PropelException
     */
    ...
    public function initComments($overrideExisting = true)
    {
        ...
        $this->collComments->setModel('\App\Services\PostService\Persistence\Propel\Comment');
    }
        ...
        if (null === $this->collComments || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collComments) {
                    ...
                    $collComments->setModel('\App\Services\PostService\Persistence\Propel\Comment');
    ...
    public function initTags()
    {
        ...
        $this->collTags->setModel('\App\Services\PostService\Persistence\Propel\Tag');
    }
