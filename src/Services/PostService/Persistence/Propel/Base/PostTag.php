...
abstract class PostTag implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Services\\PostService\\Persistence\\Propel\\Map\\PostTagTableMap';
    ...
    /**
     * Initializes internal state of App\Services\PostService\Persistence\Propel\Base\PostTag object.
     */
     ...
     * @return $this|\App\Services\PostService\Persistence\Propel\PostTag The current object (for fluent API support)
     */
    public function setPostId($v)
    {
        ...
        if ($this->post_id !== $v) {
            $this->post_id = $v;
            $this->modifiedColumns[PostTagTableMap::COL_POST_ID] = true;
        }
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[PostTagTableMap::COL_TAG_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Services\\PostService\\Persistence\\Propel\\PostTag'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostTagTableMap::COL_POST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'post_id';
        }
        if ($this->isColumnModified(PostTagTableMap::COL_TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'tag_id';
        }

        $sql = sprintf(
            'INSERT INTO post_tag (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Services\PostService\Persistence\Propel\PostTag
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Services\PostService\Persistence\Propel\PostTag The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostTagTableMap::COL_POST_ID)) {
            $criteria->add(PostTagTableMap::COL_POST_ID, $this->post_id);
        }
        if ($this->isColumnModified(PostTagTableMap::COL_TAG_ID)) {
            $criteria->add(PostTagTableMap::COL_TAG_ID, $this->tag_id);
        }
    ...
    public function hashCode()
    {
        ...
        //relation post_tag_fk_ed85ac to table post
        ...
        //relation post_tag_fk_022a95 to table tag
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Services\PostService\Persistence\Propel\PostTag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Services\PostService\Persistence\Propel\PostTag Clone of current object.
     * @throws PropelException
     */
